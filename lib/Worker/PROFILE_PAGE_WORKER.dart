                                ...
                                return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      if(image==true){
                                        ...
                                        return myAlbum('https://'+IP4+'/DUAA/PHP/upload/'+snapshot.data[index]['images'],'https://'+IP4+'/DUAA/PHP/upload/'+snapshot.data[index+1]['images'],'https://'+IP4+'/DUAA/PHP/upload/'+snapshot.data[index+2]['images'],'https://'+IP4+'/DUAA/PHP/upload/'+snapshot.data[index+3]['images'],num.toString()+"+");
                                      }
                                      return Container();
                                    }
                                );
