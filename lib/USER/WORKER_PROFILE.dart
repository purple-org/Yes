...
class  _user_worker extends State<user_worker> {
  ...
  Future getRate() async {
    var url = 'https://'+IP4+'/DUAA/PHP/show_Rate.php';
        ...
        child:Stack(
         children:[
           Container(
             ...
             child:Image(image:NetworkImage('https://'+IP4+'/DUAA/PHP/upload/'+widget.image,),),
           ),
           // Image(image:NetworkImage('https://'+IP4+'/DUAA/PHP/upload/'+widget.image,),),
    Scaffold(
                          ...
                          return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                if(snapshot.data.length>=3){
                                  return worker_Images('https://'+IP4+'/DUAA/PHP/upload/'+snapshot.data[index]['images'],'https://'+IP4+'/DUAA/PHP/upload/'+snapshot.data[index+1]['images'],'https://'+IP4+'/DUAA/PHP/upload/'+snapshot.data[index+2]['images']);
                                }
