...
class  _Conversation extends State<Conversation> {
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          child:CircleAvatar(backgroundImage: NetworkImage('https://'+IP4+'/DUAA/PHP/upload/'+widget.image),radius: 25.0,),
                        ),
                        SizedBox(width: 10,),
                        Container(
  ...
  Future saveChatImg()async{
    ...
    print(imagename);
    print(base64);
    var url = 'https://'+IP4+'/DUAA/PHP/save_ChatIMG.php';
      ...
      margin:  EdgeInsets.symmetric(vertical: 7),
        child:Container(
              ...
              decoration: BoxDecoration(
                 ...
                 :BorderRadius.only(
                  ...
                  Container(
                    ...
                    child:ClipRRect(
                      ...
                      child: Image.network('https://' + IP4 + '/DUAA/PHP/chat/' + massege,width:180,height:130,fit: BoxFit.cover,),),);
                ...
                //  //  child:ClipRRect(
                //  //    borderRadius: BorderRadius.circular(10.0),
                //  //    child: Image.network('https://' + IP4 + '/DUAA/PHP/chat/' + massege,width: 300,),),
                //  // ),
                //   decoration: BoxDecoration(
                //       borderRadius: BorderRadius.circular(20),
                //       color: Colors.yellow,
                //   ),
                // child:Image.network('https://' + IP4 + '/DUAA/PHP/chat/' + massege,),);
  }
}
