...
class _not_conferm__order extends State<not_conferm__order> {
  ...
  Future getallorders() async {
    ...
    var url = 'https://'+IP4+'/DUAA/PHP/count_not_conferm.php';
...
class _order extends State<order> {
  ...
  // Future getallorders() async {
  //   var url = 'https://'+IP4+'/DUAA/PHP/day_order_accept.php';
  //   var ressponse = await http.post(url, body: {
  //     "phone": widget.phone,
  //     "date": formattedDate,
  //   });
  ...
  Future getallorders() async {
    var formattedDate = DateFormat('yyyy-MM-dd').format(widget.time);
    var url = 'https://'+IP4+'/DUAA/PHP/day_orders.php';
    var ressponse = await http.post(url, body: {
      "phone": widget.phone,
      "date": formattedDate,
    });
...
class _new_order extends State<new_order> {
  ...
  Future delete (final id)async{
    var url = 'https://'+IP4+'/DUAA/PHP/deleteorder.php';
  ...
  Future accept (final id)async{
    var url = 'https://'+IP4+'/DUAA/PHP/acceptorder.php';
    var response = await http.post(url, body: {
      "id":id,
    });
    // String massage = json.decode(response.body);
